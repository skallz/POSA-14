...
public class SimpleSemaphore {
    ...
    public SimpleSemaphore(int permits, boolean fair) {
        ...
        this.noPermitsCondition = lock.newCondition();
    }
    ...
    public void acquireUninterruptibly() {
        ...
        try {
            while (permits <= 0) {
                noPermitsCondition.awaitUninterruptibly();
            }
            permits--;
        } finally {
            lock.unlock();
